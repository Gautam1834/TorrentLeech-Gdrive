...
class Config(object):
    ...
    LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@gautamleechbot")
    YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@gautamleechbot")
    ...
    PYTDL_COMMAND_G = os.environ.get("PYTDL_COMMAND_G", "pytdl@gautamleechbot")
    LOG_COMMAND = os.environ.get("LOG_COMMAND", "log")
    CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone@gautamleechbot")
    UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload@gautamleechbot")
